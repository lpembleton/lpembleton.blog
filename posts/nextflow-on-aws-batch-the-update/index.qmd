...
Firstly, you need to create a new [IAM](https://aws.amazon.com/iam/getting-started/?nc=sn&loc=3) user with more appropriate permissions tailored to the requirements listed in [Nextflow documentation](https://www.nextflow.io/docs/latest/awscloud.html). It is strongly recommended that do not use your root account to run Nextflow pipelines ⚠️
