...
1.  From the IAM user panel click **User groups** select your recently creates 'nextflow' group, and under the **permissions** menu click on the **Attach policy** button
...
5.  Give your new policy a name and click **Create policy**

6.  Select your newly created permission policy to add to the user group and click **Add permissions.** *Hint: you can find your new policy by* 🔍*searching in the filter box*
...
6.  To use spot instance toggle the **Use EC2 Spot instance** button at the top and define your maximum cut off for on-demand price under 'Maximum % on-demand price'. Under 'spot fleet role' you will also need to select the **AmazonEC2SpotFleetRole** role that you created earlier.
...
The last step is setting up your security credentials 🔐 to allow Nextflow to securely communicate and submit jobs to AWS batch. The best approach is to install AWS CLI locally (or in a EC2 instance if [submitting from EC2](https://www.nextflow.io/docs/latest/awscloud.html#pipeline-execution)) <https://docs.aws.amazon.com/cli/latest/userguide/getting-started-install.html>
