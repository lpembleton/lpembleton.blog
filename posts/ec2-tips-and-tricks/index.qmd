...
::: callout-caution
nvme drives on EC2 instances are typically ephemeral disks, meaning they physically exist on the actual host instance and therefore they do not persist after reboots or shutdown. All data will be lost and you will need to remount after a restart.
:::
...
Although install packages in R on windows is relatively straightforward using \`instally.packages()\`, on linux you will need to manually install any external dependencies. Below are the relevant details for some common packages
