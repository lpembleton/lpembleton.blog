...
Where `logfile` is the path and name of the log file of the relevant day. Once viewing the log results, use a lowercase {{< kbd t >}} to move forwards to the next resource usage snapshot and an upper case {{< kbd T >}} to move back.
