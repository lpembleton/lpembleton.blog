...
The following is writing with the default assumption of a Ubuntu 22.04 LTS base image
...
the tidyverse is a large collection of packages and therefore naturally there are a few dependencies. The follow should install all the required libraries.
...
The genomic selection package BLGR has two additional dependecies.
...
A similar process to VCFtools, grab the bcftools tarball from the latest [releases page](http://www.htslib.org/download/).
