...
Thanks to [Moriz E. Beber](https://github.com/Midnighter) there is a somewhat simpler method to get the container name if you know the tool versions you require. Presenting 📢 the [**Multi-Package BioContainers Image Name Generator**](https://midnighter.github.io/mulled) **🥳** This website essentially generates the hashid (mulled container name) that would exist based on the tools that you define.
